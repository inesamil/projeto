...
\resizebox{20cm}{23cm}{
	\begin{ganttchart}[
		...
		% Modelo de Dados
		\ganttgroup[progress=98.75]{Modelo de Dados}{2}{3}\\ 
		...
		% WEB API
		\ganttgroup[progress=0]{WEB API}{9}{13}\\  
		\ganttbar[progress=0]{Desenvolvimento}{9}{13}\\
		\ganttbar[progress=0]{Documentação}{13}{13} \\
		\ganttbar[progress=0]{Testes}{10}{13}  \\
		
		% Aplicações (Android e Website)
		\ganttgroup[progress=0]{Aplicações (Android e Website)}{3}{14} \\
		\ganttbar[progress=0]{Desenho das User Interfaces}{3}{4}\\
		\ganttbar[progress=0]{Desenvolvimento}{12}{14}\\
		\ganttbar[progress=0]{Documentação}{14}{14} \\
		\ganttbar[progress=0]{Testes}{13}{14}  \ganttnewline[grid]
		
		% MILESTONE: Cartaz e Versão Beta
		\ganttmilestone[ name=M3]{\textbf{Entrega do Cartaz e Versão Beta}}{14} \ganttnewline[grid]
		
		% Escrita
		\ganttgroup[progress=22.5]{Escrita}{1}{20} \\
		\ganttbar[progress=90,name=S1A]{Proposta de Projeto}{1}{4} \\
