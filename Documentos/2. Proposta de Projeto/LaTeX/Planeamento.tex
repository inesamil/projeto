...
\resizebox{20cm}{23cm}{
	\begin{ganttchart}[
		...
		% Modelo de Dados
		\ganttgroup[progress=85]{Modelo de Dados}{2}{3}\\ 
		\ganttbar[progress=95]{Descrição do Problema}{2}{2} \\ 
		\ganttbar[progress=85]{Modelo EA}{2}{2} \\
		\ganttbar[progress=85]{Modelo Relacional}{2}{2} \\
		\ganttbar[progress=85]{Domínio dos Atributos}{2}{2}  \ganttnewline[grid]
		...
		% Escrita
		\ganttgroup[progress=0]{Escrita}{1}{20} \\
