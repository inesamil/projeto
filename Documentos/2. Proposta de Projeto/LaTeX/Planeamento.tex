...
\resizebox{20cm}{23cm}{
	\begin{ganttchart}[
		...
		\ganttgroup[progress=12.5]{Aplicações (Android e Website)}{3}{13} \\
		\ganttbar[progress=50]{Desenho das User Interfaces}{3}{4}\\
		\ganttbar[progress=0]{Desenvolvimento}{11}{13}\\
		\ganttbar[progress=0]{Documentação}{13}{13} \\
		\ganttbar[progress=0]{Testes}{12}{13}  \ganttnewline[grid]
		...
		\ganttbar[progress=0,name=S1B]{Relatório de progresso}{4}{9} \\
