\section{Modelo de Dados}\label{sec34}

% Modelo EA
\subsection{Modelo Entidade-Associação}\label{subsec341}
...
\subsection{Domínio dos Atributos}\label{subsec342}
\raggedbottom
% House
\begin{table} [H]
	\centering
...
% Base de Dados
%
\subsection{Base de Dados}\label{subsec343}
...
\subsubsection{Implementação}\label{subsubsec3431}
