...
\begin{document}
	...
	\begin{ganttchart}[
		...
		\ganttgroup[progress=42]{Aplicações (Android e Website)}{3}{13} \\
		\ganttbar[progress=80]{Desenho das User Interfaces}{3}{4}\\
		\ganttbar[progress=100]{Simulação - Leitor de Tags NFC}{8}{10}\\
		\ganttbar[progress=30]{Desenvolvimento}{6}{13}\\
		...
		% Escrita
		\ganttgroup[progress=40]{Escrita}{1}{20} \\
