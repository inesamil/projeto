...
\begin{document}
	...
	\begin{ganttchart}[
		...
		% Estudo do Problema 
		\ganttgroup[progress=96.7]{Estudo do problema}{1}{2} \\
		...
		% Modelo de Dados
		\ganttgroup[progress=96.3]{Modelo de Dados}{2}{3}\\ 
		...
		\ganttgroup[progress=65]{Acesso a Dados}{5}{7}\\  
		\ganttbar[progress=95]{Desenvolvimento}{5}{7}\\
		\ganttbar[progress=100]{Documentação}{7}{7} \\
		\ganttbar[progress=0]{Testes}{5}{7} \\
		
		% Camada da Lógica de Negócio
		\ganttgroup[progress=60]{Lógica de Negócio}{7}{10}\\  
		...
		% WEB API
		\ganttgroup[progress=23.3]{WEB API}{9}{12}\\  
		\ganttbar[progress=70]{Desenvolvimento}{9}{12}\\
		\ganttbar[progress=0]{Documentação}{11}{12} \\
		\ganttbar[progress=0]{Testes}{10}{12}  \\
		
		% Aplicações (Android e Website)
		\ganttgroup[progress=24.4]{Aplicações (Android e Website)}{3}{13} \\
		\ganttbar[progress=70]{Desenho das User Interfaces}{3}{4}\\
		\ganttbar[progress=50]{Simulação - Leitor de Tags NFC}{8}{10}\\
		...
		% Escrita
		\ganttgroup[progress=39]{Escrita}{1}{20} \\
		\ganttbar[progress=100,name=S1A]{Proposta de Projeto}{1}{3} \\
		\ganttbar[progress=95,name=S1B]{Relatório de progresso}{4}{9} \\
