...
\begin{document}
	...
	\begin{ganttchart}[
		...
		\ganttgroup[progress=97.5]{Acesso a Dados}{5}{7}\\  
		...
		% WEB API
		\ganttgroup[progress=52.5]{WEB API}{9}{12}\\  
		\ganttbar[progress=95]{Desenvolvimento}{9}{12}\\
		\ganttbar[progress=0]{Documentação}{11}{12} \\
		\ganttbar[progress=10]{Testes}{10}{12}  \\
		
		% Aplicações (Android e Website)
		\ganttgroup[progress=45]{Aplicações (Android e Web)}{3}{20} \\
		\ganttbar[progress=90]{Desenho das User Interfaces}{3}{4}\\
		\ganttbar[progress=100]{Simulação - Leitor de Tags NFC}{8}{10}\\
		\ganttbar[progress=80]{Desenvolvimento da Aplicação Móvel}{6}{16}\\
		\ganttbar[progress=0]{Desenvolvimento da Aplicação Web}{14}{19}\\
		\ganttbar[progress=0]{Documentação}{12}{15} \\
		\ganttbar[progress=0]{Testes}{7}{20}  \ganttnewline[grid]
		
		% MILESTONE: Cartaz e Versão Beta
		\ganttmilestone[ name=M3]{\textbf{Entrega do Cartaz e Versão Beta}}{13} \ganttnewline[grid]
		
		% Escrita
		\ganttgroup[progress=69]{Escrita}{1}{20} \\
		\ganttbar[progress=100,name=S1A]{Proposta de Projeto}{1}{3} \\
		\ganttbar[progress=100,name=S1B]{Relatório de progresso}{4}{9} \\
		\ganttbar[progress=50,name=S5C]{Relatório Beta}{10}{13} \\
		\ganttbar[progress=0,name=S5D]{Relatório Final}{14}{20}\\
		\ganttbar[progress=95,name=S5E]{Desenvolvimento do cartaz}{11}{13} \ganttnewline[grid]
