...
class StockItemListRecyclerViewAdapter(private val context: Context, private val name: Array<String>)
    : RecyclerView.Adapter<StockItemListRecyclerViewAdapter.ViewHolder>() {
    ...
    inner class ViewHolder internal constructor(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        internal var innerAdapter: StockItemListInsideRecyclerViewAdapter
        ...
        init {
            ...
            innerAdapter = StockItemListInsideRecyclerViewAdapter()
