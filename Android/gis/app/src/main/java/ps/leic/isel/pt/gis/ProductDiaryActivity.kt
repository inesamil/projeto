...
class ProductDiaryActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener, ProductDiaryRecyclerViewAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = ProductDiaryRecyclerViewAdapter(this, diaries)
