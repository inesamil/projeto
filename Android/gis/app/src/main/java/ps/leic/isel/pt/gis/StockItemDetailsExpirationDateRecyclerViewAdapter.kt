...
class StockItemDetailsExpirationDateRecyclerViewAdapter(context: Context)
    : RecyclerView.Adapter<StockItemDetailsExpirationDateRecyclerViewAdapter.ViewHolder>() {
