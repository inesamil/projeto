...
class StockItemDetailsActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val expirationDateAdapter = StockItemDetailsExpirationDateRecyclerViewAdapter(this)
        ...
        val storageAdapter = StockItemDetailsStorageRecyclerViewAdapter(this)
        ...
        val movementsAdapter = StockItemDetailsMovementsRecyclerViewAdapter(this)
