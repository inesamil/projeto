...
class SplashScreenViewModel(private val app: Application) : AndroidViewModel(app) {
    ...
    companion object {
        ...
        //private const val url: String = "http://192.168.1.10:8081/v1" //INES
        //private const val url: String = "http://10.10.4.173:8081/v1" //ISEL
        // private const val url: String = "http://192.168.1.10:8081/v1" //CASA //TODO: mudar isto para cada pc :/
