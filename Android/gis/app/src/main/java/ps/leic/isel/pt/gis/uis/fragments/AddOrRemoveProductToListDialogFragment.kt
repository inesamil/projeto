...
import kotlinx.android.synthetic.main.layout_add_or_remove_list_product_dialog.view.*
...
class AddOrRemoveProductToListDialogFragment : DialogFragment(), AddOrRemoveProductToListAdapter.OnItemClickListener {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val view = inflater.inflate(R.layout.layout_add_or_remove_list_product_dialog, null)
